...
public abstract class PermissionHelper<T> {
    ...
    private boolean shouldShowRationale(@NonNull List<String> perms) {
    ...
    public void requestPermissions(@NonNull IRationale rationale,
                                   int requestCode,
                                   @NonNull List<String> perms) {
        if (shouldShowRationale(perms)) {
            showRequestPermissionRationale(
                    rationale, requestCode, perms);
        } else {
    ...
    public boolean somePermissionDenied(@NonNull List<String> perms) {
    ...
    public  void showRequestPermissionRationale(@NonNull IRationale rationale,
                                                int requestCode,
                                                @NonNull List<String> perms)
    {
        rationale.showRationale(getContext(),perms);
    }
    // ============================================================================
    // Public abstract methods
    // ============================================================================

    public abstract void directRequestPermissions(int requestCode, @NonNull List<String> perms);
